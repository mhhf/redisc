...
Template.llmd_blog_edit.events = {
...
Template.llmd_blog_edit.created = function(){
...
Template.llmd_blog_edit.config = function () {
  var self = this;
...
var tags = [];
Template.llmd_blog_edit.rendered = function(){
  ...
  this.data.buildAtom = function(){
    ...
    var subtitle1 = self.find('input[name=subtitle1]') && self.find('input[name=subtitle1]').value;
    var subtitle2 = self.find('input[name=subtitle2]') && self.find('input[name=subtitle2]').value;
    var owner = 'all';
    var rights = 'public';
...
Template.llmd_blog_edit.helpers({
...
Template.llmd_blog_ast.rendered = function(){
}

Template.llmd_blog_ast.helpers({
});
